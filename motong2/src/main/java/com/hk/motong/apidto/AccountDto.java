...
public class AccountDto {
	...
	public AccountDto(String fintech_use_num, String account_alias, String bank_code_std, String bank_code_sub,
			String bank_name, String account_num_masked, String account_holder_name, String account_holder_type,
			String acount_type, String inquiry_agree_yn, String inquiry_agree_dtime, String transfer_agree_yn,
			String transfer_agree_dtime, String account_state) {
		super();
	...
	public String toString() {
		return "AccountDto [fintech_use_num=" + fintech_use_num + ", account_alias=" + account_alias
				...
				+ ", account_holder_type=" + account_holder_type + ", acount_type=" + acount_type
